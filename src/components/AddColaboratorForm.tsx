...
function AddCollaboratorForm({ setModal }: AddCollaboratorFormProps) {
  ...
  return (
    <div className="w-5/6 xl:w-1/2 2xl:w-1/2 flex flex-col justify-center items-center space-y-4">
      <form className="w-full flex flex-col space-y-4">
        ...
        >
          <input
            ...
            className="w-full border border-gray-300 rounded-lg px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 "
          />
          <input
            type="text"
            name="neighborhood"
      ...
      <button
        className="w-5/6 xl:w-1/2 2xl:w-1/2 text-center text-blue-700 hover:text-blue-500 underline"
        onClick={ () => setModal() }
      >
        Adicionar colaborador(s) a partir de um arquivo
      </button>
      <div
